...
public class SoulCandleBlock extends CandleBlock {
	...
	public static void addSoulParticlesAndSound(Level level, Vec3 vec3, Random random) {
		...
		level.addParticle(BBParticles.SMALL_SOUL_FIRE_FLAME.get(), vec3.x, vec3.y, vec3.z, 0.0D, 0.0D, 0.0D);
	}
}