...
public abstract class SilverfishMixin extends Monster implements Bottleable {
	private static final EntityDataAccessor<Boolean> FROM_BOTTLE = SynchedEntityData.defineId(Silverfish.class, EntityDataSerializers.BOOLEAN);

	protected SilverfishMixin(EntityType<? extends Monster> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	public ItemStack getBottleItemStack() {
		return new ItemStack(BBItems.BOTTLE_OF_SILVERFISH.get());
	}
