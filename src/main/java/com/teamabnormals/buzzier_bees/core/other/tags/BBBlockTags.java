...
public class BBBlockTags {
	public static final Named<Block> CANDLES = tag("candles");
	public static final Named<Block> DYED_CANDLES = tag("dyed_candles");
	public static final Named<Block> SCENTED_CANDLES = tag("scented_candles");
