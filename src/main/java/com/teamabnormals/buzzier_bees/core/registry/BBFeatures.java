...
public class BBFeatures {
	...
	public static final class BBConfiguredFeatures {
		...
		public static ResourceKey<ConfiguredFeature<?, ?>> createKey(String name) {
			return ResourceKey.create(Registries.CONFIGURED_FEATURE, BuzzierBees.location(name));
		}
	...
	public static final class BBPlacedFeatures {
		...
		public static ResourceKey<PlacedFeature> createKey(String name) {
			return ResourceKey.create(Registries.PLACED_FEATURE, BuzzierBees.location(name));
		}
