...
public class BBEffects {
	public static final DeferredRegister<MobEffect> EFFECTS = DeferredRegister.create(ForgeRegistries.MOB_EFFECTS, BuzzierBees.MOD_ID);
	public static final DeferredRegister<Potion> POTIONS = DeferredRegister.create(ForgeRegistries.POTIONS, BuzzierBees.MOD_ID);

	public static final RegistryObject<MobEffect> SUNNY = EFFECTS.register("sunny", () -> new BlueprintMobEffect(MobEffectCategory.BENEFICIAL, 0xFFE451));
