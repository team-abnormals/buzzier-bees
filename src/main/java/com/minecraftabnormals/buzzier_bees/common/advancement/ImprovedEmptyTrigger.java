package com.minecraftabnormals.buzzier_bees.common.advancement;
...
public final class ImprovedEmptyTrigger implements ICriterionTrigger<ImprovedEmptyTrigger.Instance> {
	private final Map<PlayerAdvancements, Listeners> listeners = Maps.newHashMap();
	private final ResourceLocation id;

	public ImprovedEmptyTrigger(ResourceLocation id) {
		this.id = id;
	}
