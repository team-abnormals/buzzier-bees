...
{	
	...
	public static final RegistryObject<Block> WATER_HYACINTH_SCENTED_CANDLE    		= HELPER.createCompatBlock(CompatMods.ATMOSPHERIC, "water_hyacinth_scented_candle", () -> new ScentedCandleBlock(getCompatEffect(CompatMods.ATMOSPHERIC, CompatEffects.WORSENING), DyeColor.PURPLE, BBProperties.CANDLE), ItemGroup.DECORATIONS);
