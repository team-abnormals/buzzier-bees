...
public class BlockTagGenerator extends BlockTagsProvider {
	...
	public void addTags() {
		...
		this.tag(BBBlockTags.FLOWER_BLACKLIST).add(Blocks.WITHER_ROSE).addOptionalTag(new ResourceLocation("botania", "mystical_flowers")).addOptionalTag(new ResourceLocation("botania", "special_flowers"));
	}
}