...
import com.bagel.buzzier_bees.common.blocks.SoulCandleBlock;
import com.bagel.buzzier_bees.core.BuzzierBees;
import com.bagel.buzzier_bees.core.other.BBProperties;
...
{	
	...
	public static final RegistryObject<Block> CARTWHEEL_SCENTED_CANDLE    			= HELPER.createCompatBlock("environmental", "cartwheel_scented_candle", () -> new ScentedCandleBlock(() -> Effects.SPEED, BBProperties.CANDLE), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> BLUEBELL_SCENTED_CANDLE     			= HELPER.createCompatBlock("environmental", "bluebell_scented_candle", () -> new ScentedCandleBlock(() -> Effects.WATER_BREATHING, BBProperties.CANDLE), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> VIOLET_SCENTED_CANDLE       			= HELPER.createCompatBlock("environmental", "violet_scented_candle", () -> new ScentedCandleBlock(() -> Effects.INVISIBILITY, BBProperties.CANDLE), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> DIANTHUS_SCENTED_CANDLE     			= HELPER.createCompatBlock("environmental", "dianthus_scented_candle", () -> new ScentedCandleBlock(() -> Effects.STRENGTH, BBProperties.CANDLE), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> COLUMBINE_SCENTED_CANDLE    			= HELPER.createCompatBlock("environmental", "columbine_scented_candle", () -> new ScentedCandleBlock(() -> Effects.MINING_FATIGUE, BBProperties.CANDLE), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> YELLOW_HIBISCUS_SCENTED_CANDLE		= HELPER.createCompatBlock("environmental", "yellow_hibiscus_scented_candle", () -> new ScentedCandleBlock(() -> Effects.GLOWING, BBProperties.CANDLE), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> ORANGE_HIBISCUS_SCENTED_CANDLE    	= HELPER.createCompatBlock("environmental", "orange_hibiscus_scented_candle", () -> new ScentedCandleBlock(() -> Effects.GLOWING, BBProperties.CANDLE), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> RED_HIBISCUS_SCENTED_CANDLE     		= HELPER.createCompatBlock("environmental", "red_hibiscus_scented_candle", () -> new ScentedCandleBlock(() -> Effects.GLOWING, BBProperties.CANDLE), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> PINK_HIBISCUS_SCENTED_CANDLE    		= HELPER.createCompatBlock("environmental", "pink_hibiscus_scented_candle", () -> new ScentedCandleBlock(() -> Effects.GLOWING, BBProperties.CANDLE), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> MAGENTA_HIBISCUS_SCENTED_CANDLE   	= HELPER.createCompatBlock("environmental", "magenta_hibiscus_scented_candle", () -> new ScentedCandleBlock(() -> Effects.GLOWING, BBProperties.CANDLE), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> PURPLE_HIBISCUS_SCENTED_CANDLE    	= HELPER.createCompatBlock("environmental", "purple_hibiscus_scented_candle", () -> new ScentedCandleBlock(() -> Effects.GLOWING, BBProperties.CANDLE), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> WARM_MONKEY_BRUSH_SCENTED_CANDLE    	= HELPER.createCompatBlock("atmospheric", "warm_monkey_brush_scented_candle", () -> new ScentedCandleBlock(() -> (ModList.get().isLoaded("atmospheric") ? ForgeRegistries.POTIONS.getValue(new ResourceLocation("atmospheric:relief")) : null), BBProperties.CANDLE), ItemGroup.DECORATIONS);
	...
	public static final RegistryObject<Block> GILIA_SCENTED_CANDLE    				= HELPER.createCompatBlock("atmospheric", "gilia_scented_candle", () -> new ScentedCandleBlock(() -> Effects.SLOW_FALLING, BBProperties.CANDLE), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> YUCCA_FLOWER_SCENTED_CANDLE    		= HELPER.createCompatBlock("atmospheric", "yucca_flower_scented_candle", () -> new ScentedCandleBlock(() -> (ModList.get().isLoaded("atmospheric") ? ForgeRegistries.POTIONS.getValue(new ResourceLocation("atmospheric:persistence")) : null), BBProperties.CANDLE), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> PINK_SEAROCKET_SCENTED_CANDLE    		= HELPER.createCompatBlock("upgrade_aquatic", "pink_searocket_scented_candle", () -> new ScentedCandleBlock(() -> Effects.WATER_BREATHING, BBProperties.CANDLE), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> WHITE_SEAROCKET_SCENTED_CANDLE    	= HELPER.createCompatBlock("upgrade_aquatic", "white_searocket_scented_candle", () -> new ScentedCandleBlock(() -> Effects.WATER_BREATHING, BBProperties.CANDLE), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> AUTUMN_CROCUS_SCENTED_CANDLE    		= HELPER.createCompatBlock("autumnity", "autumn_crocus_scented_candle", () -> new ScentedCandleBlock(() -> (ModList.get().isLoaded("autumnity") ? ForgeRegistries.POTIONS.getValue(new ResourceLocation("autumnity:life_stasis")) : null), BBProperties.CANDLE), ItemGroup.DECORATIONS);
}
