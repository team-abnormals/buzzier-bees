...
public class HiveBoatRenderer extends EntityRenderer<HiveBoatEntity> {
   ...
   protected final HiveBoatModel modelBoat = new HiveBoatModel();
   ...
   @Override
   public void render(HiveBoatEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
      matrixStackIn.push();
