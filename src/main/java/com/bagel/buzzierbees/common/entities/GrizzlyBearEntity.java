...
public class GrizzlyBearEntity extends AnimalEntity {
   ...
   public static boolean func_223320_c(EntityType<GrizzlyBearEntity> p_223320_0_, IWorld p_223320_1_, SpawnReason reason, BlockPos p_223320_3_, Random p_223320_4_) {
      ...
      public boolean shouldExecute() {
         if (GrizzlyBearEntity.this.isChild()) {
            ...
            if (super.shouldExecute()) {
               for(GrizzlyBearEntity polarbearentity : GrizzlyBearEntity.this.world.getEntitiesWithinAABB(GrizzlyBearEntity.class, GrizzlyBearEntity.this.getBoundingBox().grow(8.0D, 4.0D, 8.0D))) {
