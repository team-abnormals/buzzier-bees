...
public class YellowForestFlowerBlockStateProvider extends BlockStateProvider {
	   private static final BlockState[] field_227401_b_ = new BlockState[]{
			   Blocks.DANDELION.getDefaultState(), 
			   ModBlocks.DAYBLOOM.get().getDefaultState()};

	   public YellowForestFlowerBlockStateProvider() {
	      super(BlockStateProviderType.field_227397_d_);
	   }

	   public <T> YellowForestFlowerBlockStateProvider(Dynamic<T> p_i225856_1_) {
	      this();
	   }
