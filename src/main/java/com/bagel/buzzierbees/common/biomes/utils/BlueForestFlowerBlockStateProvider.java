...
public class BlueForestFlowerBlockStateProvider extends BlockStateProvider {
	   private static final BlockState[] field_227401_b_ = new BlockState[]{
			   ...
			   ModBlocks.BLUEBELL.get().getDefaultState()};

	   public BlueForestFlowerBlockStateProvider() {
	      super(BlockStateProviderType.field_227397_d_);
	   }

	   public <T> BlueForestFlowerBlockStateProvider(Dynamic<T> p_i225856_1_) {
	      this();
	   }
