...
public class RedForestFlowerBlockStateProvider extends BlockStateProvider {
	   private static final BlockState[] field_227401_b_ = new BlockState[]{
			   Blocks.POPPY.getDefaultState(), 
			   Blocks.RED_TULIP.getDefaultState()};

	   public RedForestFlowerBlockStateProvider() {
	      super(BlockStateProviderType.field_227397_d_);
	   }

	   public <T> RedForestFlowerBlockStateProvider(Dynamic<T> p_i225856_1_) {
	      this();
	   }
