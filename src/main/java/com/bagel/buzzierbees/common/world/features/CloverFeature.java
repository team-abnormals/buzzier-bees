...
public class CloverFeature extends Feature<NoFeatureConfig> {
    public static final BlockState WHITE_CLOVER = ModBlocks.WHITE_CLOVER.get().getDefaultState();
    public static final BlockState PINK_CLOVER  = ModBlocks.PINK_CLOVER.get().getDefaultState();
