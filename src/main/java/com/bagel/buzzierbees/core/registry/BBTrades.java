...
public class BBTrades {
	...
	public static void onWandererTradesEvent(WandererTradesEvent event) {
		...
		event.getGenericTrades().add(new TradeUtils.ItemsForEmeraldsTrade(BBBlocks.DIANTHUS.get(), 1, 1, 8, 1));

		event.getGenericTrades().add(new TradeUtils.ItemsForEmeraldsTrade(BBBlocks.YELLOW_HIBISCUS.get(), 1, 1, 12, 1));
		event.getGenericTrades().add(new TradeUtils.ItemsForEmeraldsTrade(BBBlocks.ORANGE_HIBISCUS.get(), 1, 1, 12, 1));
		event.getGenericTrades().add(new TradeUtils.ItemsForEmeraldsTrade(BBBlocks.RED_HIBISCUS.get(), 1, 1, 12, 1));
		event.getGenericTrades().add(new TradeUtils.ItemsForEmeraldsTrade(BBBlocks.PINK_HIBISCUS.get(), 1, 1, 12, 1));
		event.getGenericTrades().add(new TradeUtils.ItemsForEmeraldsTrade(BBBlocks.MAGENTA_HIBISCUS.get(), 1, 1, 12, 1));
		event.getGenericTrades().add(new TradeUtils.ItemsForEmeraldsTrade(BBBlocks.PURPLE_HIBISCUS.get(), 1, 1, 12, 1));
	}
