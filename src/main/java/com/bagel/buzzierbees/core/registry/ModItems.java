...
public class ModItems
{
	...
	//public static RegistryObject<Item> GLAZED_HAM			= RegistryUtils.createItem("glazed_ham", () -> new CuringItem(new Item.Properties().food(ModFoods.GLAZED_HAM).group(ItemGroup.FOOD), new EffectInstance[]{new EffectInstance(Effects.WEAKNESS), new EffectInstance(Effects.POISON)}));
